import{t as e}from"./site.CHDBcplA.js";function t(e){let t=[`Hi Matt - free look request from your website.`,`Roof type: ${e.roofType}`,`Floors: ${e.stories}`,`Name: ${e.name}`,`Address: ${e.address}`,`Phone: ${e.phone}`];return e.estimate&&t.push(`Range the site showed: ${e.estimate}`),t.join(`
